...
- **дальше** — блочный RLE топологии для sparse-Packed4, обучаемый
  ...
  `pqc learn "тема"` — протокол интернет-обучения (модель сама
  формирует целевые запросы и кристаллизует найденное), GF(3)-лавина
  на больших блоках, FFI/gym-интерфейс петли
