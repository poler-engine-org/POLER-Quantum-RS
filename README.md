...
- **v0.8.0 (здесь)** — ✅ RQ18: нелинейная архетипическая алгебра —
  ...
  619 теста
- **v0.9.0 (здесь)** — ✅ RQ19: `pqc learn "ТЕМА"` — целенаправленный
...
- **дальше** — блочный RLE топологии для sparse-Packed4, обучаемый
  ...
  GF(3)-лавина на больших блоках, `pqc merge` — архетипическое
  слияние мозгов через ⊗_ε, FFI/gym-интерфейс петли
